...
public class InsertionSorting {
  ...
  private static Form[] doInsertionSorting(Form[] students) {
    System.out.printf(
        "\n\nIMPORTANT: This insertion shorting is based by final score.\n\n");
    int i = 1;
    while (i < students.length) {
      Form x = students[i];
      int j = i - 1;
      while (j >= 0 && students[j].FinalScore > x.FinalScore) {
    ...
    System.out.println("operation sort successfull, print to see the result");
    return students;
  }
  ...
  loop:
    while (true) {
      System.out.print(
          "Chose menu (1. Add | 2. Print | 3. Update | 4. Delete | 5. InsertionSorting | 6. Exit)? (1/2/3/4/5/6): ");
      switch (input.next()) {
      case "1":
      ...
      case "4":
        ...
        break;
      case "5":
        System.out.println("In insertion sorting operation");
        students = doInsertionSorting(students);
        break;
      case "6":
